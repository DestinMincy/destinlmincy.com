...
export default function CustomerQuoteDetailPage({ params }: { params: { id: string } }) {
                    ...
                    {canApprove && (
                        <>
                            <Button
                                ...
                                onClick={() => router.push(`/customer/quotes/${params.id}/approve`)}
                            >
                                ✓ Approve Quote
                            </Button>
                            <Button
                                danger
                                onClick={() => router.push(`/customer/quotes/${params.id}/reject`)}
                            >
                                ✗ Reject Quote
                            </Button>
                        </>
