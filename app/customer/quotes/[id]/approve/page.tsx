...
export default function ApproveQuotePage({ params }: { params: { id: string } }) {
    ...
    const handleApprove = async () => {
        setLoading(true);
        try {
            const response = await fetch(`/api/customer/quotes/${params.id}/approve`, {
                method: 'POST',
            });
        ...
        return (
            <div className="p-6">
                <Result
                    ...
                    extra={[
                        <Button type="primary" key="quotes" onClick={() => router.push('/customer/quotes')}>
                            View All Quotes
                        </Button>,
                        <Button key="dashboard" onClick={() => router.push('/customer/dashboard')}>
                            Go to Dashboard
                        </Button>,
                    ]}
                />
        ...
        <div className="p-6">
            <Card>
                ...
                <p className="mb-6 text-gray-700">
                    By approving this quote, you agree to the proposed work and pricing.
                    This will move the quote to the "Approved" status and we can begin work.
                </p>
                <div className="flex gap-4">
                    ...
                    <Button
                        size="large"
                        onClick={() => router.push(`/customer/quotes/${params.id}`)}
                        disabled={loading}
                    >
                        Cancel
                    </Button>
